  ...
  const HomePage = ()=>{
    ...
    return (
      <div style={{opacity:mounted?1:0,transition:"opacity 0.4s",display:"flex",flexDirection:"column",gap:20}}>
        ...
        {/* Hero */}
        <div style={{background:`linear-gradient(135deg, rgba(10,120,90,0.75), rgba(10,80,140,0.75), rgba(10,50,140,0.75)), url('/hero.jpg')`,backgroundSize:"cover",backgroundPosition:"center top",borderRadius:T.rXl,padding:"40px 48px",
